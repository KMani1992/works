...
import it.cnr.imaa.essi.lablib.gui.checkboxtree.SingleTreeCheckingMode;
import it.cnr.imaa.essi.lablib.gui.checkboxtree.TreeCheckingEvent;
import it.cnr.imaa.essi.lablib.gui.checkboxtree.TreeCheckingListener;
import it.cnr.imaa.essi.lablib.gui.checkboxtree.TreeCheckingMode;
import it.cnr.imaa.essi.lablib.gui.checkboxtree.TreeCheckingModel;
import it.cnr.imaa.essi.lablib.gui.checkboxtree.examples.CustTreeNode;
 ...
 */
// TODO: CustCheckModel allows to set null tree models, which will
// however
// cause nullPointerException (setTreeModel calls clearChecking...)
// Fix, either allowing or banning null tree models.
public class CustCheckModel extends DefaultTreeCheckingModel implements TreeCheckingModel {
	...
	public void treeNodesInserted(TreeModelEvent e) {
	    TreePath path = e.getTreePath();
	    CustCheckModel.this.checkingMode.updateCheckAfterChildrenInserted(path);
	}
	...
	public void treeNodesRemoved(TreeModelEvent e) {
	    TreePath path = e.getTreePath();
	    CustCheckModel.this.checkingMode.updateCheckAfterChildrenRemoved(path);
	}
	...
	public void treeStructureChanged(TreeModelEvent e) {
	    TreePath path = e.getTreePath();
	    CustCheckModel.this.checkingMode.updateCheckAfterStructureChanged(path);
	}
    }
    ...
    /**
     * Creates a CustCheckModel with PropagateTreeCheckingMode.
     */
    public CustCheckModel(TreeModel model) {
	super(model);
        if (model == null) {
...
//    }
    ...
    void removeFromCheckedPathsSet(TreePath path) {
        ...
        if (obj instanceof CustTreeNode) {
            ...
            System.out.println(node.toString() + " remove");
        }

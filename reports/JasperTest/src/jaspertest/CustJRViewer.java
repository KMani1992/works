 ...
 */
public class CustJRViewer extends javax.swing.JPanel implements JRHyperlinkListener
{
	private static final Log log = LogFactory.getLog(CustJRViewer.class);

	private static final long serialVersionUID = JRConstants.SERIAL_VERSION_UID;

	/**
	 * Maximum size (in pixels) of a buffered image that would be used by {@link CustJRViewer JRViewer} to render a report page.
	 * <p>
	 ...
	 */
	public CustJRViewer(String fileName, boolean isXML) throws JRException
	{
	 ...
	 */
	public CustJRViewer(InputStream is, boolean isXML) throws JRException
	{
		this(is, isXML, null);
	}
	 ...
	 */
	public CustJRViewer(JasperPrint jrPrint)
	{
		this(jrPrint, null);
	}
	 ...
	 * @see #JRViewer(JasperReportsContext, String, boolean, Locale, ResourceBundle)
	 */
	public CustJRViewer(String fileName, boolean isXML, Locale locale) throws JRException
	{
	 ...
	 * @see #JRViewer(JasperReportsContext, InputStream, boolean, Locale, ResourceBundle)
	 */
	public CustJRViewer(InputStream is, boolean isXML, Locale locale) throws JRException
	{
	 ...
	 * @see #JRViewer(JasperReportsContext, JasperPrint, Locale, ResourceBundle)
	 */
	public CustJRViewer(JasperPrint jrPrint, Locale locale)
	{
	 ...
	 * @see #JRViewer(JasperReportsContext, String, boolean, Locale, ResourceBundle)
	 */
	public CustJRViewer(String fileName, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException
	{
		this(
	 ...
	 * @see #JRViewer(JasperReportsContext, InputStream, boolean, Locale, ResourceBundle)
	 */
	public CustJRViewer(InputStream is, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException
	{
		this(
			DefaultJasperReportsContext.getInstance(), 
			is, 
	 ...
	 * @see #JRViewer(JasperReportsContext, JasperPrint, Locale, ResourceBundle)
	 */
	public CustJRViewer(JasperPrint jrPrint, Locale locale, ResourceBundle resBundle)
	{
		this(
			DefaultJasperReportsContext.getInstance(), 
			jrPrint, 
				...
				new Runnable()
				{
					...
					public void run()
					{
						try
						{
							...
							CustJRViewer.this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
						...
						catch (Exception ex)
						{
							...
							JOptionPane.showMessageDialog(CustJRViewer.this, getBundleString("error.printing"));
						}
						finally
						{
							CustJRViewer.this.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	...
	*/
	protected void loadReport(InputStream is, boolean isXmlReport) throws JRException
	{
        ...
        private volatile int lastMaxPage=0;
	...
	*/
	protected void loadReport(JasperPrint jrPrint)
	{
        ...
        private void setMaxPg(JasperPrint jrPrint) {
            int currMaxPage = jrPrint.getPages().size();
            if (lastMaxPage != currMaxPage) {
                lastMaxPage = currMaxPage;
                setPageIndex(currMaxPage - 1);
                refreshPage();
	...
	protected JRGraphics2DExporter getGraphics2DExporter() throws JRException
	{
		return 
			new JRGraphics2DExporter(jasperReportsContext)
			{
				...
				{
					return CustJRViewer.this.getRenderersCache();
				}
			};
	}
	...
	protected void paintPage(Graphics2D grx)
	{
		...
		catch(Exception e)
		{
			...
			SwingUtilities.invokeLater(new Runnable()
			{
				...
				public void run()
				{
					JOptionPane.showMessageDialog(CustJRViewer.this, getBundleString("error.displaying"));
				}
			});
		}
	...
	*/
	class PageRenderer extends JLabel
	{
		...
		CustJRViewer viewer = null;

		public PageRenderer(CustJRViewer viewer)
		{
			this.viewer = viewer;
		}
